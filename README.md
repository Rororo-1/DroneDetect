...
Спочатку планувалось, що детекцією і ідентифікацією займатиметься база ResNet50 з 2-3 шарами голови.
Перед останнім був би шар активації softmax для класифікації і останнім був би linear для детекції.
